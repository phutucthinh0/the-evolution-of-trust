function PayoffsUI(config){
	...
	// Labels
	dom.appendChild(_makeLabel("label_cooperate", {x:163, y:20, w:70, rotation:45, align:"center", color:"#cccccc"}));
	dom.appendChild(_makeLabel("label_cooperate", {x:58, y:20, w:70, rotation:-45, align:"center", color:"#cccccc"}));
	dom.appendChild(_makeLabel("label_cheat", {x:235, y:85, w:70, rotation:45, align:"center", color:"#cccccc"}));
	dom.appendChild(_makeLabel("label_cheat", {x:-6, y:85, w:70, rotation:-45, align:"center", color:"#cccccc"}));
